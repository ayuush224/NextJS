...
export default function HeroSection(){
    return (
        <div className="h-auto md:h-160 w-full rounded-md flex flex-col
        items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
            ...
            <div className="mt-4">
                <Link href={"/courses"}>
                    ...
                    className="bg-white dark:bg-slate-900 text-black dark:text-white border-neutral-200 dark:border-slate-800 cursor-pointer text-xl">
                        Explore
                    </Button>
                </Link>
            </div>
